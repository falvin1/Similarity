<div class="w-64 bg-white shadow-md">
    ...
    <div class="px-6 py-2">
      ...
      <div class="mt-2">
        <span class="bg-blue-100 text-blue-800 text-xs px-3 py-1 rounded-full">Administrator</span>
      </div>
    </div>
    ...
    <div class="mt-6">
      ...
      <a href="documents" class="flex items-center px-6 py-3 text-gray-600 hover:bg-gray-100">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <a href="profile" class="flex items-center px-6 py-3 text-gray-600 hover:bg-gray-100">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
